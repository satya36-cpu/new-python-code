...
# application routers
from app.views import user_app
...
def init_routers(app: FastAPI) -> None:
    app.include_router(user_app,  tags=["policy"])
...
def create_app() -> FastAPI:
    app = FastAPI(
        title="ADMIN MANAGER",
        description="ADMIN MANAGER  is a service which is able to manage all ADMIN OF ZAPS LOYALTY SYSTEM",
        version="1.0.0",
